...
describe(`elements`, () => {
  describe(`Polyline`, () => {
    ...
    let polyline: Polyline<TestState>;
    beforeAll(() => {
      ...
      polyline = new Polyline<TestState>(renderCallback);
    });

    describe(`tagName`, () => {
      it(`is polyline`, () => {
        expect(polyline.tagName).toEqual(`polyline`);
      });
    });

    describe(`children`, () => {
      it(`is empty`, () => {
        expect(polyline.children).toEqual([]);
      });
    });
    ...
    describe(`render`, () => {
      ...
      beforeAll(() => {
        rendered = polyline.render(`Test State`);
      });
