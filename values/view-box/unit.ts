...
describe(`values`, () => {
  describe(`Position`, () => {
    describe(`without position`, () => {
      describe(`width`, () => {
        Helpers.renders(`rounds down`, () => new ViewBox(24.4, 1), `24 1 0 0`);
        Helpers.renders(`rounds up`, () => new ViewBox(24.6, 1), `25 1 0 0`);
        ...
        Helpers.throws(
          `NaN`,
          () => new ViewBox(Number.NaN, 1),
          `ViewBox.width must be a number`
        );

        Helpers.throws(
          `positive infinity`,
          () => new ViewBox(Number.POSITIVE_INFINITY, 1),
          `ViewBox.width must be finite`
        );

        Helpers.throws(
          `negative infinity`,
          () => new ViewBox(Number.NEGATIVE_INFINITY, 1),
          `ViewBox.width must be finite`
        );
      });

      describe(`height`, () => {
        Helpers.renders(`rounds down`, () => new ViewBox(1, 24.4), `1 24 0 0`);
        Helpers.renders(`rounds up`, () => new ViewBox(1, 24.6), `1 25 0 0`);
        ...
        Helpers.throws(
          `NaN`,
          () => new ViewBox(1, Number.NaN),
          `ViewBox.height must be a number`
        );

        Helpers.throws(
          `positive infinity`,
          () => new ViewBox(1, Number.POSITIVE_INFINITY),
          `ViewBox.height must be finite`
        );

        Helpers.throws(
          `negative infinity`,
          () => new ViewBox(1, Number.NEGATIVE_INFINITY),
          `ViewBox.height must be finite`
        );
      });
    });
    ...
    describe(`with position`, () => {
      ...
      describe(`leftX`, () => {
        ...
        Helpers.throws(
          ...
          `ViewBox.leftX must be a number when given`
        );

        Helpers.throws(
          `positive infinity`,
          () => new ViewBox(1, 1, Number.POSITIVE_INFINITY, 47),
          `ViewBox.leftX must be finite when given`
        );
      ...
      describe(`topY`, () => {
        ...
        Helpers.throws(
          ...
          `ViewBox.topY must be a number when given`
        );

        Helpers.throws(
          `positive infinity`,
          () => new ViewBox(1, 1, 47, Number.POSITIVE_INFINITY),
          `ViewBox.topY must be finite when given`
        );
